...
export default function SimpleSlider() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto py-10 px-4 sm:px-6 md:px-10 overflow-hidden">
      
      <h1 className="text-3xl md:text-5xl text-center mt-5 mb-3 font-semibold">
        एक प्रमुख पहल
      </h1>
      <Slider {...settings}>
