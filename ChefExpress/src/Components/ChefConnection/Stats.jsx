    ...
    <section className="text-gray-600 body-font">
      <div className="container mx-auto py-10">
        ...
        <div className="grid grid-cols-3 gap-3 text-center">
          {/* Card 1 */}
          <div className="relative p-3 border rounded-lg md:border-0 md:p-6">
            {/* Background Icon only on desktop */}
            <div className="hidden md:block absolute top-1/2 right-4 transform -translate-y-1/2 opacity-15 text-6xl text-gray-400 pointer-events-none">
              <FaUtensils />
            </div>
