...
const Low = () => {
  return (
    <div>
         <section className="text-black bg-neutral-500 body-font overflow-hidden">
      <div className="container px-8 py-8">
        <div className="lg:w-4/5 flex flex-wrap">
          <img
            alt="Chefs"
            className="lg:w-1/2 w-full lg:h-auto h-full object-cover object-center rounded-md"
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-10">
            ...
            <h1 className="text-gray-900 text-3xl sm:text-4xl lg:text-6xl title-font font-extrabold mb-1">
